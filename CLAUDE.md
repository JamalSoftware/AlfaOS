...
**Próxima fase recomendada: `RC-1C` — CustomerLocation**, depois da decisão do dono sobre `RC-LOC-01`. Não iniciada. **Não iniciar `FIELD-MAP-1` durante a `RC-1` sem nova ordem do OWNER.**
