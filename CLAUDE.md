...
**Próxima fase: `RC-1D`** — copy desatualizada, códigos crus da timeline da OS, acessibilidade e o E2E intermitente `MAPEDIT` (`docs/MASTER-PLAN.md` §12). **Não iniciada**: começa só com ordem do dono. **Não iniciar `FIELD-MAP-1` durante a `RC-1` sem nova ordem do OWNER.**
