...
**`NF-4` (deep link do toque) e `NF-5` (piloto físico) continuam `PLANNED`.** Os commits da NF-1, NF-2 e NF-3 são locais, não publicados, e **não devem ser reescritos, amendados nem squashados**.
