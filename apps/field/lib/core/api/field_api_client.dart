...
class FieldApiClient {
  ...
  Future<Map<String, dynamic>> _send(
    ...
    try {
      ...
      throw const FieldException.network();
    }
    ...
    throw await _mapError(status, data);
  }
  ...
  /// estourar.
  Future<FieldException> _mapError(int status, dynamic data) async {
    ...
    */
    if (exception.endsSession && _onSessionEnded != null) {
